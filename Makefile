...
DS4_TEST_QWEN38_MODEL ?= /home/diegom/models/Qwen3.8-27B/Qwen3.8-27B-GSQ-RCO-IQ3_S.gguf
DS4_TEST_QWEN38_MMPROJ ?= /home/diegom/models/Qwen3.8-27B/mmproj-Qwen3.8-27B-BF16.gguf
DS4_TEST_QWEN38_IMAGE ?= /tmp/white224.png
DS4_TEST_QWEN38_MTP ?= /home/diegom/models/Qwen3.8-27B/Qwen3.8-27B-NVFP4-MTP-HIGHEST.gguf
...
CORE_OBJS = ds4.o ds4_image.o ds4_video.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_video.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
else
...
CORE_OBJS = ds4.o ds4_image.o ds4_video.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_video.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
...
ds4-server: ds4_server.o ds4_prompt_prefix.o ds4_help.o ds4_kvstore.o rax.o ds4_gpu_args.o $(CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ ds4_server.o ds4_prompt_prefix.o ds4_help.o ds4_kvstore.o rax.o ds4_gpu_args.o $(CORE_OBJS) $(METAL_LDLIBS)
...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_eval_cases.o ds4_agent_cpu.o ds4_help.o ds4_prompt_prefix.o ds4_web.o ds4_kvstore.o linenoise.o rax.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS)
	...
	$(CC) $(CFLAGS) -o ds4-server ds4_server_cpu.o ds4_help.o ds4_prompt_prefix.o ds4_kvstore.o rax.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS) $(LDLIBS)
...
tests/test_qwen38_steering: tests/test_qwen38_steering.o $(CORE_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)

tests/test_qwen38_steering_cpu.o: tests/test_qwen38_steering.c ds4.h
	$(CC) $(filter-out -ffast-math,$(CFLAGS)) -DDS4_NO_GPU -I. -c -o $@ $<

tests/test_qwen38_steering_cpu: tests/test_qwen38_steering_cpu.o $(CPU_CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
tests/test_qwen3vl_video.o: tests/test_qwen3vl_video.c ds4.h ds4_image.h ds4_video.h
	$(CC) $(filter-out -ffast-math,$(CFLAGS)) -I. -c -o $@ $<

tests/test_qwen3vl_video: tests/test_qwen3vl_video.o $(CORE_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)

.PHONY: test-qwen3vl-video
test-qwen3vl-video: tests/test_qwen3vl_video
	@command -v ffmpeg >/dev/null 2>&1 || { \
		echo "test-qwen3vl-video: ffmpeg not in PATH, skipping"; exit 0; \
	}
	./tests/test_qwen3vl_video "$(DS4_TEST_QWEN38_MODEL)" "$(DS4_TEST_QWEN38_MMPROJ)"
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_linux_memory.h ds4_video.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c

ds4_video.o: ds4_video.c ds4_video.h ds4_image.h
	$(CC) $(CFLAGS) -c -o $@ $<
...
ds4_cuda.o: ds4_cuda.cu ds4_gpu.h ds4_gpu_mgpu.h ds4_glm53_vision_gpu.cuh ds4_deepseek4_vision_gpu.cuh ds4_qwen3vl_vision_gpu.cuh ds4_image.h ds4_iq2_tables_cuda.inc cuda/mmq/ds4_mmq.h
...
clean:
	...
	rm -f tests/test_qwen38_cuda tests/test_qwen38_session_cuda tests/test_qwen38_cuda_perf tests/test_qwen3vl_vision tests/test_qwen3vl_session tests/test_qwen3vl_video
	rm -f tests/test_qwen38_steering tests/test_qwen38_steering_cpu
	...
	rm -f ds4 ds4-server ds4-bench ds4-eval ds4-agent ds4_cpu ds4_native ds4_server_test ds4_test ds4_agent_test gguf-tools/quality-testing/score_official gguf-tools/quality-testing/score_official.o speed-bench/metal_decode_schedule_bench speed-bench/metal_prefill_variant_bench speed-bench/*.o tests/test_q4k_dot tests/test_mxfp4_dot tests/test_mxfp4_metal tests/test_mxfp4_rocm tests/test_mxfp4_cuda tests/test_qwen3vl_image tests/test_qwen3vl_video tests/test_metal_session_batch tests/test_metal_moe_prefill tests/test_metal_dense_mpp tests/test_glm53_kda tests/test_glm53_kda_rocm tests/test_glm53_vision_engine tests/test_glm53_vision_prompt tests/test_deepseek4_vision_image tests/test_prompt_prefix tests/test_gpu_xdev tests/test_gpu_model_cache tests/test_gpu_lookup_cache_strict tests/test_engine_mgpu_refusal tests/test_engine_mgpu_runtime tests/test_engine_correctness tests/test_sampling tests/test_cuda_session_batch tests/test_cuda_mixed_batch tests/*.o *.o tests/cuda_long_context_smoke tests/cuda_long_context_smoke.o
