...
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_gdn_decode)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_gdn_chunk)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_ga_prepare)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_ga_prepare_chunk)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_ga_decode)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_ga_chunk)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen3vl_vision_encode)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen3vl_vision_encode_pair)
ROCM_UNAVAILABLE_INT(ds4_gpu_memory_info)
ROCM_UNAVAILABLE_INT(ds4_gpu_phase_mark)
ROCM_UNAVAILABLE_INT(ds4_gpu_phase_finish)
extern "C" void ds4_gpu_phase_reset(...) { }
